...
export function InventoryPage({
  ...
  return (
    <section className="grid gap-6 xl:grid-cols-[1.4fr_0.8fr] w-full max-w-full min-w-0">
      <article className="w-full max-w-full min-w-0 overflow-hidden rounded-[1.5rem] border border-[color:var(--border)] bg-[color:var(--surface)] p-4 shadow-sm sm:rounded-[1.75rem] sm:p-6">
        ...
        <div className="overflow-x-auto w-full max-w-full min-w-0 rounded-[1.4rem] border border-[color:var(--border)] bg-white">
